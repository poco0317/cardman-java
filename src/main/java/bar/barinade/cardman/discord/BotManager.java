...
import bar.barinade.cardman.discord.handler.BasicButtonHandler;
import bar.barinade.cardman.discord.handler.BasicMessageHandler;
import bar.barinade.cardman.discord.handler.CommandHandlerBase;
import bar.barinade.cardman.discord.handler.ServerConfigCommandHandler;
...
public class BotManager {
	...
	private void initialize() throws LoginException, InterruptedException {
		...
		// fun
		builder.setActivity(Activity.playing("Distributing keys"));
		...
		final BasicButtonHandler buttons = springContext.getBean(BasicButtonHandler.class);
		builder.addEventListeners(configCommands, msgCommands, buttons);
